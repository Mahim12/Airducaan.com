        ...
        <div class="row mb-lg-5 mb-md-5 mb-5">
            <div class="offset-lg-3 offset-md-3 col-lg-6 col-md-6 col-12">
                <div class="contact-form-background" id="contact">
                    ...
                    <form method="post" action="submitform.php" target="_self">
                    ...
                    array_push($firstname2, $firstname1);
                    $lastname1 = $_POST["lastname"];
                    array_push($lastname2, $lastname1);
                    $email1 = $_POST["email"];
                    array_push($email2, $email1);
                    $mobile1 = $_POST["mobile"];
                    array_push($mobile2, $mobile1);
                    $dob1 = $_POST["dob"];
                    array_push($dob2, $dob1);
                    $gender1 = $_POST["gender"];
                    array_push($gender2, $gender1);
                    $comment1 = $_POST["comment"];
                    array_push($comment2, $comment1);
                    ...
                    /*
                    $insertvalues = "INSERT INTO `contact` (firstname,lastname,email,mobile,dob,gender,comment) VALUES ($firstname1,$lastname1,$email1,$mobile1,$dob1,$gender1,$comment1)";
                    $conn->query($insertvalues);
                    */

                    $it = array_map(null, $firstname2, $lastname2, $email2, $mobile2, $dob2, $gender2, $comment2);
                    foreach ($it as $a) {
                        $insertvalues = "INSERT INTO `contact` (firstname,lastname,email,mobile,dob,gender,comment) VALUES ('$a[0]','$a[1]','$a[2]','$a[3]','$a[4]','$a[5]','$a[6]')";
                        $conn->query($insertvalues);
                    }
                    ?>
